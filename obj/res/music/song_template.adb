M:song_template
S:Lsong_template.set_2bpp_palette$palette$1_0$26({2}SI:U),B,1,-2
S:Lsong_template.set_1bpp_colors$bgcolor$1_0$29({1}SC:U),B,1,-1
S:Lsong_template.set_1bpp_colors$fgcolor$1_0$29({1}SC:U),B,1,-2
S:Lsong_template.set_bkg_based_tiles$w$1_0$35({1}SC:U),B,1,2
S:Lsong_template.set_bkg_based_tiles$h$1_0$35({1}SC:U),B,1,3
S:Lsong_template.set_bkg_based_tiles$tiles$1_0$35({2}DG,SC:U),B,1,4
S:Lsong_template.set_bkg_based_tiles$base_tile$1_0$35({1}SC:U),B,1,6
S:Lsong_template.set_bkg_based_tiles$y$1_0$35({1}SC:U),B,1,-1
S:Lsong_template.set_bkg_based_tiles$x$1_0$35({1}SC:U),B,1,-2
S:Lsong_template.set_bkg_based_submap$w$1_0$38({1}SC:U),B,1,2
S:Lsong_template.set_bkg_based_submap$h$1_0$38({1}SC:U),B,1,3
S:Lsong_template.set_bkg_based_submap$map$1_0$38({2}DG,SC:U),B,1,4
S:Lsong_template.set_bkg_based_submap$map_w$1_0$38({1}SC:U),B,1,6
S:Lsong_template.set_bkg_based_submap$base_tile$1_0$38({1}SC:U),B,1,7
S:Lsong_template.set_bkg_based_submap$y$1_0$38({1}SC:U),B,1,-1
S:Lsong_template.set_bkg_based_submap$x$1_0$38({1}SC:U),B,1,-2
S:Lsong_template.move_bkg$y$1_0$43({1}SC:U),B,1,-1
S:Lsong_template.move_bkg$x$1_0$43({1}SC:U),B,1,-2
S:Lsong_template.scroll_bkg$y$1_0$45({1}SC:S),B,1,-1
S:Lsong_template.scroll_bkg$x$1_0$45({1}SC:S),B,1,-2
S:Lsong_template.set_win_based_tiles$w$1_0$52({1}SC:U),B,1,2
S:Lsong_template.set_win_based_tiles$h$1_0$52({1}SC:U),B,1,3
S:Lsong_template.set_win_based_tiles$tiles$1_0$52({2}DG,SC:U),B,1,4
S:Lsong_template.set_win_based_tiles$base_tile$1_0$52({1}SC:U),B,1,6
S:Lsong_template.set_win_based_tiles$y$1_0$52({1}SC:U),B,1,-1
S:Lsong_template.set_win_based_tiles$x$1_0$52({1}SC:U),B,1,-2
S:Lsong_template.set_win_based_submap$w$1_0$55({1}SC:U),B,1,2
S:Lsong_template.set_win_based_submap$h$1_0$55({1}SC:U),B,1,3
S:Lsong_template.set_win_based_submap$map$1_0$55({2}DG,SC:U),B,1,4
S:Lsong_template.set_win_based_submap$map_w$1_0$55({1}SC:U),B,1,6
S:Lsong_template.set_win_based_submap$base_tile$1_0$55({1}SC:U),B,1,7
S:Lsong_template.set_win_based_submap$y$1_0$55({1}SC:U),B,1,-1
S:Lsong_template.set_win_based_submap$x$1_0$55({1}SC:U),B,1,-2
S:Lsong_template.move_win$y$1_0$60({1}SC:U),B,1,-1
S:Lsong_template.move_win$x$1_0$60({1}SC:U),B,1,-2
S:Lsong_template.scroll_win$y$1_0$62({1}SC:S),B,1,-1
S:Lsong_template.scroll_win$x$1_0$62({1}SC:S),B,1,-2
S:Lsong_template.SET_SHADOW_OAM_ADDRESS$address$1_0$67({2}DG,SV:S),B,1,-2
S:Lsong_template.set_sprite_tile$tile$1_0$69({1}SC:U),B,1,-1
S:Lsong_template.set_sprite_tile$nb$1_0$69({1}SC:U),B,1,-2
S:Lsong_template.get_sprite_tile$nb$1_0$71({1}SC:U),B,1,-1
S:Lsong_template.set_sprite_prop$prop$1_0$73({1}SC:U),B,1,-1
S:Lsong_template.set_sprite_prop$nb$1_0$73({1}SC:U),B,1,-2
S:Lsong_template.get_sprite_prop$nb$1_0$75({1}SC:U),B,1,-1
S:Lsong_template.move_sprite$y$1_0$77({1}SC:U),B,1,2
S:Lsong_template.move_sprite$x$1_0$77({1}SC:U),B,1,-1
S:Lsong_template.move_sprite$nb$1_0$77({1}SC:U),B,1,-2
S:Lsong_template.move_sprite$itm$1_0$78({2}DG,STOAM_item_t:S),B,1,-4
S:Lsong_template.scroll_sprite$y$1_0$79({1}SC:S),B,1,2
S:Lsong_template.scroll_sprite$x$1_0$79({1}SC:S),B,1,-1
S:Lsong_template.scroll_sprite$nb$1_0$79({1}SC:U),B,1,-2
S:Lsong_template.scroll_sprite$itm$1_0$80({2}DG,STOAM_item_t:S),B,1,-4
S:Lsong_template.hide_sprite$nb$1_0$81({1}SC:U),B,1,-1
S:Lsong_template.set_native_tile_data$data$1_0$89({2}DG,SC:U),B,1,2
S:Lsong_template.set_native_tile_data$nb_tiles$1_0$89({1}SC:U),B,1,-1
S:Lsong_template.set_native_tile_data$first_tile$1_0$89({2}SI:U),B,1,-3
F:G$__func_song_template$0_0$0({2}DF,SV:S),C,0,0,0,0,0
T:Fsong_template$__00000000[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Fsong_template$__00000001[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Fsong_template$__00000002[({0}S:S$npads$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({4}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({1}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Fsong_template$__00000003[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({0}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Fsong_template$__00000004[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)]
T:Fsong_template$_fixed[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)({0}S:S$b$0_0$0({2}ST__00000001:S),Z,0,0)({0}S:S$w$0_0$0({2}SI:U),Z,0,0)]
T:Fsong_template$hUGESong_t[({0}S:S$tempo$0_0$0({1}SC:U),Z,0,0)({1}S:S$order_cnt$0_0$0({2}DG,SC:U),Z,0,0)({3}S:S$order1$0_0$0({2}DG,DG,SC:U),Z,0,0)({5}S:S$order2$0_0$0({2}DG,DG,SC:U),Z,0,0)({7}S:S$order3$0_0$0({2}DG,DG,SC:U),Z,0,0)({9}S:S$order4$0_0$0({2}DG,DG,SC:U),Z,0,0)({11}S:S$duty_instruments$0_0$0({2}DG,SC:U),Z,0,0)({13}S:S$wave_instruments$0_0$0({2}DG,SC:U),Z,0,0)({15}S:S$noise_instruments$0_0$0({2}DG,SC:U),Z,0,0)({17}S:S$routines$0_0$0({2}DG,DG,DC,DF,SV:S),Z,0,0)({19}S:S$waves$0_0$0({2}DG,SC:U),Z,0,0)]
T:Fsong_template$OAM_item_t[({0}S:S$y$0_0$0({1}SC:U),Z,0,0)({1}S:S$x$0_0$0({1}SC:U),Z,0,0)({2}S:S$tile$0_0$0({1}SC:U),Z,0,0)({3}S:S$prop$0_0$0({1}SC:U),Z,0,0)]
...
S:G$__func_song_template$0_0$0({2}DF,SV:S),C,0,0
S:Fsong_template$order_cnt$0_0$0({1}SC:U),D,0,0
S:Fsong_template$P0$0_0$0({192}DA192d,SC:U),D,0,0
S:Fsong_template$P1$0_0$0({192}DA192d,SC:U),D,0,0
S:Fsong_template$order1$0_0$0({2}DA1d,DG,SC:U),D,0,0
S:Fsong_template$order2$0_0$0({2}DA1d,DG,SC:U),D,0,0
S:Fsong_template$order3$0_0$0({2}DA1d,DG,SC:U),D,0,0
S:Fsong_template$order4$0_0$0({2}DA1d,DG,SC:U),D,0,0
S:Fsong_template$duty_instruments$0_0$0({60}DA60d,SC:U),D,0,0
S:Fsong_template$wave_instruments$0_0$0({60}DA60d,SC:U),D,0,0
S:Fsong_template$noise_instruments$0_0$0({120}DA120d,SC:U),D,0,0
S:Fsong_template$waves$0_0$0({256}DA256d,SC:U),D,0,0
