M:sfxplayer
S:Lsfxplayer.set_2bpp_palette$palette$1_0$26({2}SI:U),B,1,-2
S:Lsfxplayer.set_1bpp_colors$bgcolor$1_0$29({1}SC:U),B,1,-1
S:Lsfxplayer.set_1bpp_colors$fgcolor$1_0$29({1}SC:U),B,1,-2
S:Lsfxplayer.set_bkg_based_tiles$w$1_0$35({1}SC:U),B,1,2
S:Lsfxplayer.set_bkg_based_tiles$h$1_0$35({1}SC:U),B,1,3
S:Lsfxplayer.set_bkg_based_tiles$tiles$1_0$35({2}DG,SC:U),B,1,4
S:Lsfxplayer.set_bkg_based_tiles$base_tile$1_0$35({1}SC:U),B,1,6
S:Lsfxplayer.set_bkg_based_tiles$y$1_0$35({1}SC:U),B,1,-1
S:Lsfxplayer.set_bkg_based_tiles$x$1_0$35({1}SC:U),B,1,-2
S:Lsfxplayer.set_bkg_based_submap$w$1_0$38({1}SC:U),B,1,2
S:Lsfxplayer.set_bkg_based_submap$h$1_0$38({1}SC:U),B,1,3
S:Lsfxplayer.set_bkg_based_submap$map$1_0$38({2}DG,SC:U),B,1,4
S:Lsfxplayer.set_bkg_based_submap$map_w$1_0$38({1}SC:U),B,1,6
S:Lsfxplayer.set_bkg_based_submap$base_tile$1_0$38({1}SC:U),B,1,7
S:Lsfxplayer.set_bkg_based_submap$y$1_0$38({1}SC:U),B,1,-1
S:Lsfxplayer.set_bkg_based_submap$x$1_0$38({1}SC:U),B,1,-2
S:Lsfxplayer.move_bkg$y$1_0$43({1}SC:U),B,1,-1
S:Lsfxplayer.move_bkg$x$1_0$43({1}SC:U),B,1,-2
S:Lsfxplayer.scroll_bkg$y$1_0$45({1}SC:S),B,1,-1
S:Lsfxplayer.scroll_bkg$x$1_0$45({1}SC:S),B,1,-2
S:Lsfxplayer.set_win_based_tiles$w$1_0$52({1}SC:U),B,1,2
S:Lsfxplayer.set_win_based_tiles$h$1_0$52({1}SC:U),B,1,3
S:Lsfxplayer.set_win_based_tiles$tiles$1_0$52({2}DG,SC:U),B,1,4
S:Lsfxplayer.set_win_based_tiles$base_tile$1_0$52({1}SC:U),B,1,6
S:Lsfxplayer.set_win_based_tiles$y$1_0$52({1}SC:U),B,1,-1
S:Lsfxplayer.set_win_based_tiles$x$1_0$52({1}SC:U),B,1,-2
S:Lsfxplayer.set_win_based_submap$w$1_0$55({1}SC:U),B,1,2
S:Lsfxplayer.set_win_based_submap$h$1_0$55({1}SC:U),B,1,3
S:Lsfxplayer.set_win_based_submap$map$1_0$55({2}DG,SC:U),B,1,4
S:Lsfxplayer.set_win_based_submap$map_w$1_0$55({1}SC:U),B,1,6
S:Lsfxplayer.set_win_based_submap$base_tile$1_0$55({1}SC:U),B,1,7
S:Lsfxplayer.set_win_based_submap$y$1_0$55({1}SC:U),B,1,-1
S:Lsfxplayer.set_win_based_submap$x$1_0$55({1}SC:U),B,1,-2
S:Lsfxplayer.move_win$y$1_0$60({1}SC:U),B,1,-1
S:Lsfxplayer.move_win$x$1_0$60({1}SC:U),B,1,-2
S:Lsfxplayer.scroll_win$y$1_0$62({1}SC:S),B,1,-1
S:Lsfxplayer.scroll_win$x$1_0$62({1}SC:S),B,1,-2
S:Lsfxplayer.SET_SHADOW_OAM_ADDRESS$address$1_0$67({2}DG,SV:S),B,1,-2
S:Lsfxplayer.set_sprite_tile$tile$1_0$69({1}SC:U),B,1,-1
S:Lsfxplayer.set_sprite_tile$nb$1_0$69({1}SC:U),B,1,-2
S:Lsfxplayer.get_sprite_tile$nb$1_0$71({1}SC:U),B,1,-1
S:Lsfxplayer.set_sprite_prop$prop$1_0$73({1}SC:U),B,1,-1
S:Lsfxplayer.set_sprite_prop$nb$1_0$73({1}SC:U),B,1,-2
S:Lsfxplayer.get_sprite_prop$nb$1_0$75({1}SC:U),B,1,-1
S:Lsfxplayer.move_sprite$y$1_0$77({1}SC:U),B,1,2
S:Lsfxplayer.move_sprite$x$1_0$77({1}SC:U),B,1,-1
S:Lsfxplayer.move_sprite$nb$1_0$77({1}SC:U),B,1,-2
S:Lsfxplayer.move_sprite$itm$1_0$78({2}DG,STOAM_item_t:S),B,1,-4
S:Lsfxplayer.scroll_sprite$y$1_0$79({1}SC:S),B,1,2
S:Lsfxplayer.scroll_sprite$x$1_0$79({1}SC:S),B,1,-1
S:Lsfxplayer.scroll_sprite$nb$1_0$79({1}SC:U),B,1,-2
S:Lsfxplayer.scroll_sprite$itm$1_0$80({2}DG,STOAM_item_t:S),B,1,-4
S:Lsfxplayer.hide_sprite$nb$1_0$81({1}SC:U),B,1,-1
S:Lsfxplayer.set_native_tile_data$data$1_0$89({2}DG,SC:U),B,1,2
S:Lsfxplayer.set_native_tile_data$nb_tiles$1_0$89({1}SC:U),B,1,-1
S:Lsfxplayer.set_native_tile_data$first_tile$1_0$89({2}SI:U),B,1,-3
S:Lsfxplayer.sfx_sound_cut_mask$mask$1_0$105({1}SC:U),B,1,-1
S:Lsfxplayer.sfx_set_sample$sample$1_0$108({2}DG,SC:U),B,1,-2
S:Lsfxplayer.sfx_set_sample$bank$1_0$108({1}SC:U),B,1,-3
F:G$sfx_play_isr$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
T:Fsfxplayer$__00000000[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Fsfxplayer$__00000001[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Fsfxplayer$__00000002[({0}S:S$npads$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({4}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({1}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Fsfxplayer$__00000003[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({0}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Fsfxplayer$__00000004[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)]
T:Fsfxplayer$_fixed[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)({0}S:S$b$0_0$0({2}ST__00000001:S),Z,0,0)({0}S:S$w$0_0$0({2}SI:U),Z,0,0)]
T:Fsfxplayer$OAM_item_t[({0}S:S$y$0_0$0({1}SC:U),Z,0,0)({1}S:S$x$0_0$0({1}SC:U),Z,0,0)({2}S:S$tile$0_0$0({1}SC:U),Z,0,0)({3}S:S$prop$0_0$0({1}SC:U),Z,0,0)]
